...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://github.com/harshhaareddy/SparkXcloud-Gdrive-MirrorBot"><i class="fab fa-github"></i></a>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See SparkXcloud-Gdrive-MirrorBot <a href='https://github.com/harshhaareddy/SparkXcloud-Gdrive-MirrorBot'>@GitHub</a> By <a href='https://github.com/harshhaareddy'>harshhaareddy</a></h1>", content_type="text/html")
